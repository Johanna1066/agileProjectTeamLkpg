...
The class has two methods; initiateServo - does all of the necessary electronic setup
                                           for the hardware to work properly.
                           setDirection -  takes one argument inDirection(int) that is rescaled
                                           using  the arduino map-funtion to the desired new direction
                                           for the engine.
